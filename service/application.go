...
func NewApplication(config Config) app.Application {
	...
	return app.Application{
		...
		Queries: app.Queries{
			...
			InviteGetByEmail:        query.NewInviteGetByEmailHandler(inviteRepo, inviteFactory),
			InviteGetByUUID:         query.NewInviteGetByUUIDHandler(inviteRepo, inviteFactory),
			InviteGetByBusinessUUID: query.NewInviteGetByBusinessUUIDHandler(inviteRepo, inviteFactory),
		},
	}
}
